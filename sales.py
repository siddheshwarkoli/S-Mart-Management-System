...
class salesClass:
    def __init__(self,root):
        ...
        #=====Image=====
        self.bill__photo=Image.open("images/cat2.jpg")
        self.bill__photo=self.bill__photo.resize((400,300),Image.LANCZOS)
        self.bill__photo=ImageTk.PhotoImage(self.bill__photo)
        
        lbl_image=Label(self.root,image=self.bill__photo,bd=0)
